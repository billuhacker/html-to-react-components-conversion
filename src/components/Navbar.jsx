...
const Navbar = ({ toggleSidebar }) => {
  ...
  return (
    <nav className="bg-gray-600 shadow-md p-4 flex justify-between items-center z-30 relative text-white">
      {/* Left - Profile and Name */}
      <div className="flex items-center space-x-4 cursor-pointer" onClick={toggleDropdown}>
        <span className="text-white font-medium">Bilawal Mughal</span>
        <img
      ...
      {/* Profile Dropdown */}
      {dropdownOpen && (
        <div className="absolute left-0 mt-2 w-48 bg-white border rounded-lg shadow-lg py-2">
      ...
      <div className="relative">
        <button className="text-white focus:outline-none" onClick={toggleNotificationDropdown}>
